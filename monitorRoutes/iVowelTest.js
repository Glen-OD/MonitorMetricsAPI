...
const API_BASE_URL = process.env.API_VOWEL_URL
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        if(data.answer == 14)
        {
            ...
            {    
                data = "URL 1 for VowelCount working as expected. Time taken: " + t3.toFixed(2) + " milliseconds."
            }
            else{
                dataString = data.x
            ...
            data = "Answer expected was 14 received: " + dataAnswer + ". Time taken: " + t3.toFixed(2) + " milliseconds."
        }
        //console.log(data)
